	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataflowdiagramPackage.DATA_FLOW_DIAGRAM: {
				...
				if (result == null) result = caseEntity(dataFlowDiagram);
				if (result == null) result = caseIdentifier(dataFlowDiagram);
				if (result == null) result = caseNamedElement(dataFlowDiagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowdiagramPackage.FLOW: {
				Flow flow = (Flow)theEObject;
				T result = caseFlow(flow);
				if (result == null) result = caseEntity(flow);
				if (result == null) result = caseIdentifier(flow);
				if (result == null) result = caseNamedElement(flow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataflowdiagramPackage.EXTERNAL: {
				External external = (External)theEObject;
				T result = caseExternal(external);
				if (result == null) result = caseNode(external);
				if (result == null) result = caseEntity(external);
				if (result == null) result = caseIdentifier(external);
				if (result == null) result = caseNamedElement(external);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
